 ...
 */
public class PersistentConnectionListenerex implements ConnectionListener {

    private static final String LOGTAG = LogUtil
            .makeLogTag(PersistentConnectionListenerex.class);

    private final XmppManagerex xmppManager;

    public PersistentConnectionListenerex(XmppManagerex xmppManager) {
