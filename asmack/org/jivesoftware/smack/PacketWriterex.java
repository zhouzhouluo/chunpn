...
class PacketWriterex {
     ...
     */
    protected PacketWriterex(XMPPConnectionex connection) {
    ...
    */ 
     ...
     * @throws Exception 
     */
    void startKeepAliveProcess(XmppManagerex xmppManager) throws Exception {
    ...
    private void writePackets(Thread thisThread) {
        try {
            ...
            while (!done && (writerThread == thisThread)) {
                ...
                if (packet != null) {
                    synchronized (writer) {
                    	System.out.println("222222222222222222222222222222222222222:"+packet.toXML());
            ...
            try {
                synchronized (writer) {
                   while (!queue.isEmpty()) {
                       ...
                       System.out.println("3333333333333333333333333333333333333333333:"+packet.toXML());
                        writer.write(packet.toXML());
                    }
                    writer.flush();
                }
    ...
    private class KeepAliveTask implements Runnable {
        ...
        private XmppManagerex xmppManager;

        public KeepAliveTask(int delay, XmppManagerex xmppManager) {
            this.delay = delay;
